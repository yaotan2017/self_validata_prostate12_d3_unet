...
def get_training_and_validation_generators(data_file, patch_shape, batch_size, n_labels, training_list,validation_list,
                                           binary_num_rate,min_point,pos_num_rate, nag_num_rate,validation_patch_overlap=0,
    ...
    print('train_generateor is done....')
    num_training_steps = get_number_of_steps(get_number_of_patches(data_file, training_list, binary_num_rate,
                                                                   min_point, pos_num_rate, nag_num_rate, patch_shape=patch_shape,
    ...
    num_validation_steps = get_number_of_steps(get_number_of_patches(data_file, validation_list,binary_num_rate,
                                                                     min_point=0, pos_num_rate=0, nag_num_rate=0, patch_shape=patch_shape,
...
def data_generator(data_file, index_list, batch_size,binary_num_rate=0,min_point=0,pos_num_rate=0, nag_num_rate=0,
                   n_labels=1,patch_shape=None,patch_overlap=0,augment=False, augment_flip=False,
