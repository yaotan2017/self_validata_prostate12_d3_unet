...
from generators_all import get_training_and_validation_generators
...
config["save_fpath"] = '/media/laomaotao/0A9AD66165F33762/ty/prostate_3d_segmentation/result/d3-unet/2019-12-3_all_new'
...
def get_data(data_fpath):
    ...
    train_list=list(range(len(image_indexs)))
    ...
    return datas,train_list,train_name
